                            ...
                            <div className="header-top">
                                <Title level={4}>
                                    ...
                                    <Text className="subtitle">
                                        آپشن های داشبورد را اینجا ببینید.
                                    </Text>
                                </Title>
                            </div>

                            <div className="sidebar-color">
                                <Title level={5}>رنگ نوار کناره</Title>
                                ...
                                <div className="sidebarnav-color mb-2">
                                    <Title level={5}>نوع نوار کناره</Title>
                                    <Text>
                                        از بین دو نوع نوار کناره انتخاب کنید.
                                    </Text>
                                ...
                                <div className="fixed-nav mb-2">
                                    <Title level={5}>نوار بالا ثابت </Title>
                                    <Switch
